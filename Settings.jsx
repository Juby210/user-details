    ...
    render() {
        return <>
            ...
            <SwitchItem
                ...
                note={ this.props.getSetting('defaultFirstMessage')
            ...
            <SwitchItem
                value={ this.props.getSetting('defaultFirstMessage') }
                onChange={ () => this.props.toggleSetting('defaultFirstMessage') }
                disabled={ !this.props.getSetting('lastMessage', true) }
